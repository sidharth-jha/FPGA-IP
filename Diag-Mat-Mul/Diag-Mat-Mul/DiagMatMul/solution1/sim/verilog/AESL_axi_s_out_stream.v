...
`define TV_OUT_out_stream_TDATA "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_data_V.dat"
`define EGRESS_STATUS_out_stream_TDATA "../tv/stream_size/stream_egress_status_out_stream_V_data_V.dat"
`define TV_OUT_out_stream_TKEEP "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_keep_V.dat"
`define EGRESS_STATUS_out_stream_TKEEP "../tv/stream_size/stream_egress_status_out_stream_V_keep_V.dat"
`define TV_OUT_out_stream_TSTRB "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_strb_V.dat"
`define EGRESS_STATUS_out_stream_TSTRB "../tv/stream_size/stream_egress_status_out_stream_V_strb_V.dat"
`define TV_OUT_out_stream_TLAST "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_last_V.dat"
...
module AESL_axi_s_out_stream (
    ...
    fifo #(16, 32) fifo_out_stream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 4) fifo_out_stream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 4) fifo_out_stream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
