...
`define AUTOTB_DUT      matmul
`define AUTOTB_DUT_INST AESL_inst_matmul
`define AUTOTB_TOP      apatb_matmul_top
`define AUTOTB_LAT_RESULT_FILE "matmul.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "matmul.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_matmul_top
...
`define AUTOTB_TVIN_in_stream_V_data_V  "./c.matmul.autotvin_in_stream_V_data_V.dat"
`define AUTOTB_TVIN_in_stream_V_keep_V  "./c.matmul.autotvin_in_stream_V_keep_V.dat"
`define AUTOTB_TVIN_in_stream_V_strb_V  "./c.matmul.autotvin_in_stream_V_strb_V.dat"
`define AUTOTB_TVIN_in_stream_V_last_V  "./c.matmul.autotvin_in_stream_V_last_V.dat"
`define AUTOTB_TVIN_out_stream_V_data_V  "./c.matmul.autotvin_out_stream_V_data_V.dat"
`define AUTOTB_TVIN_out_stream_V_keep_V  "./c.matmul.autotvin_out_stream_V_keep_V.dat"
`define AUTOTB_TVIN_out_stream_V_strb_V  "./c.matmul.autotvin_out_stream_V_strb_V.dat"
`define AUTOTB_TVIN_out_stream_V_last_V  "./c.matmul.autotvin_out_stream_V_last_V.dat"
`define AUTOTB_TVIN_in_stream_V_data_V_out_wrapc  "./rtl.matmul.autotvin_in_stream_V_data_V.dat"
`define AUTOTB_TVIN_in_stream_V_keep_V_out_wrapc  "./rtl.matmul.autotvin_in_stream_V_keep_V.dat"
`define AUTOTB_TVIN_in_stream_V_strb_V_out_wrapc  "./rtl.matmul.autotvin_in_stream_V_strb_V.dat"
`define AUTOTB_TVIN_in_stream_V_last_V_out_wrapc  "./rtl.matmul.autotvin_in_stream_V_last_V.dat"
`define AUTOTB_TVIN_out_stream_V_data_V_out_wrapc  "./rtl.matmul.autotvin_out_stream_V_data_V.dat"
`define AUTOTB_TVIN_out_stream_V_keep_V_out_wrapc  "./rtl.matmul.autotvin_out_stream_V_keep_V.dat"
`define AUTOTB_TVIN_out_stream_V_strb_V_out_wrapc  "./rtl.matmul.autotvin_out_stream_V_strb_V.dat"
`define AUTOTB_TVIN_out_stream_V_last_V_out_wrapc  "./rtl.matmul.autotvin_out_stream_V_last_V.dat"
`define AUTOTB_TVOUT_out_stream_V_data_V  "./c.matmul.autotvout_out_stream_V_data_V.dat"
`define AUTOTB_TVOUT_out_stream_V_keep_V  "./c.matmul.autotvout_out_stream_V_keep_V.dat"
`define AUTOTB_TVOUT_out_stream_V_strb_V  "./c.matmul.autotvout_out_stream_V_strb_V.dat"
`define AUTOTB_TVOUT_out_stream_V_last_V  "./c.matmul.autotvout_out_stream_V_last_V.dat"
`define AUTOTB_TVOUT_out_stream_V_data_V_out_wrapc  "./impl_rtl.matmul.autotvout_out_stream_V_data_V.dat"
`define AUTOTB_TVOUT_out_stream_V_keep_V_out_wrapc  "./impl_rtl.matmul.autotvout_out_stream_V_keep_V.dat"
`define AUTOTB_TVOUT_out_stream_V_strb_V_out_wrapc  "./impl_rtl.matmul.autotvout_out_stream_V_strb_V.dat"
`define AUTOTB_TVOUT_out_stream_V_last_V_out_wrapc  "./impl_rtl.matmul.autotvout_out_stream_V_last_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1302;
parameter LENGTH_in_stream_V_data_V = 512;
parameter LENGTH_in_stream_V_keep_V = 512;
parameter LENGTH_in_stream_V_strb_V = 512;
parameter LENGTH_in_stream_V_last_V = 512;
parameter LENGTH_out_stream_V_data_V = 16;
parameter LENGTH_out_stream_V_keep_V = 16;
parameter LENGTH_out_stream_V_strb_V = 16;
parameter LENGTH_out_stream_V_last_V = 16;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.matmul.autotvout_out_stream_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.matmul.autotvout_out_stream_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matmul.autotvout_out_stream_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matmul.autotvout_out_stream_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.matmul.autotvout_out_stream_V_data_V.dat with impl_rtl.matmul.autotvout_out_stream_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.matmul.autotvout_out_stream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.matmul.autotvout_out_stream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matmul.autotvout_out_stream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matmul.autotvout_out_stream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.matmul.autotvout_out_stream_V_keep_V.dat with impl_rtl.matmul.autotvout_out_stream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.matmul.autotvout_out_stream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.matmul.autotvout_out_stream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matmul.autotvout_out_stream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matmul.autotvout_out_stream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.matmul.autotvout_out_stream_V_strb_V.dat with impl_rtl.matmul.autotvout_out_stream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.matmul.autotvout_out_stream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.matmul.autotvout_out_stream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matmul.autotvout_out_stream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matmul.autotvout_out_stream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.matmul.autotvout_out_stream_V_last_V.dat with impl_rtl.matmul.autotvout_out_stream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
