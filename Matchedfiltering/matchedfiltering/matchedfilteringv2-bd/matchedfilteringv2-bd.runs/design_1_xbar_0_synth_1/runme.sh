...
HD_PWD='/home/iiitd/Documents/Sidharth_BTP/matchedfiltering/v2/matchedfiltering/matchedfilteringv2-bd/matchedfilteringv2-bd.runs/design_1_xbar_0_synth_1'
cd "$HD_PWD"
