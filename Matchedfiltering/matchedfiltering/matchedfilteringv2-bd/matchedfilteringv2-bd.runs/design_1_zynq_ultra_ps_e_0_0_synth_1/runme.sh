...
HD_PWD='/home/iiitd/Documents/Sidharth_BTP/matchedfiltering/v2/matchedfiltering/matchedfilteringv2-bd/matchedfilteringv2-bd.runs/design_1_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
