...
// [dump_struct_tree [build_nameSpaceTree] dumpedStructList] ---------->
    ...
    template<> struct ap_axiu<64, 0, 0, 0> {
        ap_uint<64> data;
        ap_uint<8> keep;
        ap_uint<8> strb;
        ap_uint<1> last;
...
#define AUTOTB_TVOUT_PC_out_stream_V_data_V  "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_data_V.dat"
// tvout file define: "out_stream_V_keep_V"
#define AUTOTB_TVOUT_PC_out_stream_V_keep_V  "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_keep_V.dat"
// tvout file define: "out_stream_V_strb_V"
#define AUTOTB_TVOUT_PC_out_stream_V_strb_V  "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_strb_V.dat"
// tvout file define: "out_stream_V_last_V"
#define AUTOTB_TVOUT_PC_out_stream_V_last_V  "../tv/rtldatafile/rtl.matmul.autotvout_out_stream_V_last_V.dat"
...
extern void matmul (
hls::stream<ap_axiu<64, 0, 0, 0 > > (&in_stream),
hls::stream<ap_axiu<64, 0, 0, 0 > > (&out_stream));

void AESL_WRAP_matmul (
hls::stream<ap_axiu<64, 0, 0, 0 > > (&in_stream),
hls::stream<ap_axiu<64, 0, 0, 0 > > (&out_stream))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		std::vector<ap_axiu<64, 0, 0, 0 > > aesl_tmp_3;
		int aesl_tmp_4;
		int aesl_tmp_5 = 0;
	...
	else
	{
		...
		std::vector<ap_axiu<64, 0, 0, 0 > > aesl_tmp_0;
		int aesl_tmp_1 = 0;
...
// [call_c_dut] ---------->
     ...
     if (aesl_tmp_1 > aesl_tmp_2)
     {
		...
		for (int i = 0; i < aesl_tmp_1 - aesl_tmp_2; i++)
		{
		    ...
		    sc_int<32> stream_ingress_size_in_stream_V_data_V = 0;
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_in_stream_V_data_V, stream_ingress_size_in_stream_V_data_V.to_string().c_str());
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_in_stream_V_data_V, "\n");
     }
     ...
     if (aesl_tmp_1 > aesl_tmp_2)
     {
		...
		for (int i = 0; i < aesl_tmp_1 - aesl_tmp_2; i++)
		{
		    ...
		    sc_int<32> stream_ingress_size_in_stream_V_keep_V = 0;
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_in_stream_V_keep_V, stream_ingress_size_in_stream_V_keep_V.to_string().c_str());
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_in_stream_V_keep_V, "\n");
     }
     ...
     if (aesl_tmp_1 > aesl_tmp_2)
     {
		...
		for (int i = 0; i < aesl_tmp_1 - aesl_tmp_2; i++)
		{
		    ...
		    sc_int<32> stream_ingress_size_in_stream_V_strb_V = 0;
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_in_stream_V_strb_V, stream_ingress_size_in_stream_V_strb_V.to_string().c_str());
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_in_stream_V_strb_V, "\n");
     }
