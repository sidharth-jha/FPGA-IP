...
`define TV_IN_in_stream_TDATA "../tv/cdatafile/c.matmul.autotvin_in_stream_V_data_V.dat"
`define INGRESS_STATUS_in_stream_TDATA "../tv/stream_size/stream_ingress_status_in_stream_V_data_V.dat"
`define TV_IN_in_stream_TKEEP "../tv/cdatafile/c.matmul.autotvin_in_stream_V_keep_V.dat"
`define INGRESS_STATUS_in_stream_TKEEP "../tv/stream_size/stream_ingress_status_in_stream_V_keep_V.dat"
`define TV_IN_in_stream_TSTRB "../tv/cdatafile/c.matmul.autotvin_in_stream_V_strb_V.dat"
`define INGRESS_STATUS_in_stream_TSTRB "../tv/stream_size/stream_ingress_status_in_stream_V_strb_V.dat"
`define TV_IN_in_stream_TLAST "../tv/cdatafile/c.matmul.autotvin_in_stream_V_last_V.dat"
...
module AESL_axi_s_in_stream (
    ...
    output [8 - 1:0] TRAN_in_stream_TKEEP,
    output [8 - 1:0] TRAN_in_stream_TSTRB,
    ...
    fifo #(256, 64) fifo_in_stream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] in_stream_TKEEP_write_data;
    reg in_stream_TKEEP_read_en;
    wire [8 - 1:0] in_stream_TKEEP_read_data;
    
    fifo #(256, 8) fifo_in_stream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] in_stream_TSTRB_write_data;
    reg in_stream_TSTRB_read_en;
    wire [8 - 1:0] in_stream_TSTRB_read_data;
    
    fifo #(256, 8) fifo_in_stream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_in_stream_TVALID_temp = ~(in_stream_TDATA_empty || in_stream_TKEEP_empty || in_stream_TSTRB_empty || in_stream_TLAST_empty) || (in_stream_TDATA_valid && in_stream_TKEEP_valid && in_stream_TSTRB_valid && in_stream_TLAST_valid);
