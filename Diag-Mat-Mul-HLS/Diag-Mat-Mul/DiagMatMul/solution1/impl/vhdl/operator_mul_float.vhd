...
architecture behav of operator_mul_float is 
    ...
    signal tmp_i_reg_104 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_50_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_i_reg_109 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_56_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_i_reg_114 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_62_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_5_i_reg_119 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal p_x_M_real_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal p_x_M_imag_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal p_y_M_real_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal p_y_M_imag_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    matmul_fmul_32ns_dEe_U3 : component matmul_fmul_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    matmul_fmul_32ns_dEe_U4 : component matmul_fmul_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    matmul_fmul_32ns_dEe_U5 : component matmul_fmul_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    matmul_fmul_32ns_dEe_U6 : component matmul_fmul_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
