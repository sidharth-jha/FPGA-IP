...
set ID 679
set hasByteEnable 0
set MemName dmatmult_rxmat_M_eOg
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 680 \
			corename dmatmult_control_axilite \
			name dmatmult_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dmatmult_control_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_stream_TDATA { I 64 vector } in_stream_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_stream_TDATA { O 64 vector } out_stream_TREADY { I 1 bit } } \
} "
} else {
