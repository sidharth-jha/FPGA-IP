...
set structArgument2 [list 32 0 0 0 ]
set NameSpace2 [list ]
set structIsPacked2 "0"
set DataType2 [list "ap_axiu<32, 0, 0, 0>" "struct ap_axiu" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
